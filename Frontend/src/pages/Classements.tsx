...
//   const basketballPlayerRankings = [
...
//   const basketballAssistRankings = [
...
//   return (
//     <div className="classements-container p-5">
//       {/* Classement des Équipes de Football */}
//       <h2 className="text-center text-2xl mb-5">Classement des Équipes de Football</h2>
//       <h3 className="text-center text-lg mb-5">PreSeason Tournament ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Rang</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Nom de l'équipe</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Points</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Journée</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Victoires</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Défaites</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Nuls</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Buts Marqués</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Buts Encaissés</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Différence de Buts</th>
//           </tr>
//         </thead>
//         <tbody>
//           {footballRankings.map((team) => (
//             <tr key={team.teamName}>
//               <td className="border border-[#ddd] p-2">{team.rank}</td>
//               <td className="border border-[#ddd] p-2">{team.teamName}</td>
//               <td className="border border-[#ddd] p-2">{team.points}</td>
//               <td className="border border-[#ddd] p-2">{team.matchday}</td>
//               <td className="border border-[#ddd] p-2">{team.wins}</td>
//               <td className="border border-[#ddd] p-2">{team.losses}</td>
//               <td className="border border-[#ddd] p-2">{team.draws}</td>
//               <td className="border border-[#ddd] p-2">{team.goalsScored}</td>
//               <td className="border border-[#ddd] p-2">{team.goalsConceded}</td>
//               <td className="border border-[#ddd] p-2">{team.goalDifference}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>

//       {/* Classement des Buteurs de Football */}
//       <h2 className="text-center text-2xl mb-5">Classement des Buteurs de Football</h2>
//       <h3 className="text-center text-lg mb-5">PreSeason Tournament ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Rang</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Nom</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Prénom</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Équipe</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Buts</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Matchs Joués</th>
//           </tr>
//         </thead>
//         <tbody>
//           {footballPlayerRankings.map((player) => (
//             <tr key={`${player.playerName}-${player.playerSurname}`}>
//               <td className="border border-[#ddd] p-2">{player.rank}</td>
//               <td className="border border-[#ddd] p-2">{player.playerName}</td>
//               <td className="border border-[#ddd] p-2">{player.playerSurname}</td>
//               <td className="border border-[#ddd] p-2">{player.teamName}</td>
//               <td className="border border-[#ddd] p-2">{player.goals}</td>
//               <td className="border border-[#ddd] p-2">{player.matchesPlayed}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>

//       {/* Classement des Passeurs de Football */}
//       <h2 className="text-center text-2xl mb-5">Classement des Passeurs de Football</h2>
//       <h3 className="text-center text-lg mb-5">PreSeason Tournament ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
...
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Prénom</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Équipe</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Passes Décisives</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Matchs Joués</th>
//           </tr>
//         </thead>
//         <tbody>
//           {footballAssistRankings.map((passer) => (
//             <tr key={`${passer.playerName}-${passer.playerSurname}`}>
//               <td className="border border-[#ddd] p-2">{passer.rank}</td>
//               <td className="border border-[#ddd] p-2">{passer.playerName}</td>
//               <td className="border border-[#ddd] p-2">{passer.playerSurname}</td>
//               <td className="border border-[#ddd] p-2">{passer.teamName}</td>
//               <td className="border border-[#ddd] p-2">{passer.assists}</td>
//               <td className="border border-[#ddd] p-2">{passer.matchesPlayed}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
...
//       <h2 className="text-center text-2xl mb-5">Classement des Équipes de Basketball/Handball</h2>
//       <h3 className="text-center text-lg mb-5">PLAYOFFS / Catégorie : Basketball ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Rang</th>
...
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Victoires</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Défaites</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Points Marqués</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Points Encaissés</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Différence de Points</th>
//           </tr>
//         </thead>
//         <tbody>
//           {basketballRankings.map((team) => (
//             <tr key={team.teamName}>
//               <td className="border border-[#ddd] p-2">{team.rank}</td>
//               <td className="border border-[#ddd] p-2">{team.teamName}</td>
//               <td className="border border-[#ddd] p-2">{team.points}</td>
...
//               <td className="border border-[#ddd] p-2">{team.wins}</td>
//               <td className="border border-[#ddd] p-2">{team.losses}</td>
//               <td className="border border-[#ddd] p-2">{team.pointsScored}</td>
//               <td className="border border-[#ddd] p-2">{team.pointsConceded}</td>
//               <td className="border border-[#ddd] p-2">{team.pointDifference}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
...
//       <h2 className="text-center text-2xl mb-5">Classement des Joueurs de Basketball (Points par Match)</h2>
//       <h3 className="text-center text-lg mb-5">PLAYOFFS / Catégorie : Basketball ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
...
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Prénom</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Équipe</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Points par Match</th>
//           </tr>
//         </thead>
//         <tbody>
//           {basketballPlayerRankings.map((player) => (
//             <tr key={`${player.playerName}-${player.playerSurname}`}>
//               <td className="border border-[#ddd] p-2">{player.rank}</td>
//               <td className="border border-[#ddd] p-2">{player.playerName}</td>
//               <td className="border border-[#ddd] p-2">{player.playerSurname}</td>
//               <td className="border border-[#ddd] p-2">{player.teamName}</td>
//               <td className="border border-[#ddd] p-2">{player.pointsPerMatch}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
...
//       <h2 className="text-center text-2xl mb-5">Classement des Passeurs de Basketball (Passes par Match)</h2>
//       <h3 className="text-center text-lg mb-5">PLAYOFFS / Catégorie : Basketball ( 1ère Journée )</h3>
//       <table className="w-full border-collapse mb-5">
//         <thead>
//           <tr>
...
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Prénom</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Équipe</th>
//             <th className="border border-[#ddd] p-2 bg-[#f2f2f2] font-bold">Passes par Match</th>
//           </tr>
//         </thead>
//         <tbody>
//           {basketballAssistRankings.map((passer) => (
//             <tr key={`${passer.playerName}-${passer.playerSurname}`}>
//               <td className="border border-[#ddd] p-2">{passer.rank}</td>
//               <td className="border border-[#ddd] p-2">{passer.playerName}</td>
//               <td className="border border-[#ddd] p-2">{passer.playerSurname}</td>
//               <td className="border border-[#ddd] p-2">{passer.teamName}</td>
//               <td className="border border-[#ddd] p-2">{passer.assistsPerMatch}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
