  ...
  useEffect(() => {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          ...
          (error) => {
            ...
            setLatitude(14.6919)
            setLongitude(-17.4744)
            updateMapUrl()
          },
        )
      } else {
        console.error("La géolocalisation n'est pas supportée par ce navigateur.")
        // Utiliser des coordonnées par défaut si la géolocalisation n'est pas supportée
        setLatitude(52.3676)
        setLongitude(4.9041)
        updateMapUrl()
      }
    ...
    const updateMapUrl = () => {
      if (latitude !== null && longitude !== null) {
        setMapUrl(
          `https://www.google.com/maps/embed/v1/view?key=AIzaSyCj_wefax4CP6AT3tj1Jd7uDjFbOALJ6HU&center=${latitude},${longitude}&zoom=14`,
        )
      }
    }
