...
//   const updateMapUrl = () => {
//     setMapUrl(`https://www.google.com/maps/embed/v1/view?key=AIzaSyDC2wWagFPRT6baQ78SMG69jX8ZjWSsTSE&center=${latitude},${longitude}&zoom=14`);
//   };
...
//           <h1 className="text-[2.5rem] font-bold mb-5">Contact</h1>
//           <p className="text-[1.1rem] mb-5 leading-[1.5]">
//             Nous serions ravis de vous aider ! N’hésitez pas à nous contacter si vous avez des questions !
//           </p>
//           <div className="advice-box p-3 my-4 flex items-center bg-[#f0f4f8] border-l-[5px] border-[#007bff] text-[#333]">
//             <FaInfoCircle className="mr-2 text-[#007bff]" />
//             <span>Conseil : regardez nos <a href="#" className="text-[#007bff] hover:underline">vidéos explicatives</a> avant de nous contacter.</span>
//           </div>
//           <ul className="list-none text-[1rem] leading-[1.6]">
//             <li className="mb-4"><strong className="block mt-4">E-mail</strong><br />toornament@gmail.com</li>
//             <li className="mb-4"><strong className="block mt-4">Numéro de téléphone</strong><br />+221 77 461 64 18</li>
//             <li><strong className="block mt-4">Adresse postale</strong><br />Dakar<br />Golf Nord<br />Sénégal</li>
//           </ul>
//         </div>
